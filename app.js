...
function conditionFieldType(field){var meta=findField(field);if(field==="休假申请单·孕周"||/月数|天数|时长/.test(field)){return "number";}if(/日期|预产期/.test(field)){return "date";}if(/是否/.test(field)){return "boolean";}if(meta&&meta.values){return "enum";}return "text";}
